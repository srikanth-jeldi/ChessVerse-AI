...
active games can be restored after reconnecting.
...
history and use coaching tools to understand threats, mistakes and promising
moves. Adaptive training helps focus practice on areas that need improvement.
...
Build your chess network with friends, clubs, tournaments, challenges and
private chat. Message delivery and read status help conversations stay in sync,
and you can share user-selected images or files with a friend.
...
- Friends, clubs, tournaments, private challenges and chat
- Message delivery/read status and optional chat attachments
- Personalized notifications for social and chess activity
