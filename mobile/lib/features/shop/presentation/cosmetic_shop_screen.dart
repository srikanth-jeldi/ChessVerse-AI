...
class _CosmeticShopScreenState extends State<CosmeticShopScreen> {
  ...
  Widget _tabs() => Padding(
    ...
    child: Wrap(
      spacing: 10,
      children: [
        for (final t in ['BOARD', 'PIECES', 'FRAME'])
          ChoiceChip(
            label: Text(switch (t) {
              'BOARD' => 'BOARDS',
              'PIECES' => '3D PIECES',
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: FilledButton.icon(
                    ...
                    style: FilledButton.styleFrom(
                      backgroundColor: item.priceCurrency == 'DIAMONDS'
  ...
  Widget _badgePreview(CosmeticItemDto item, Color accent) => Container(
    decoration: BoxDecoration(
      ...
      gradient: const RadialGradient(
        colors: [Color(0xFF173A55), Color(0xFF071625)],
      ),
      border: Border.all(color: accent.withValues(alpha: .8), width: 2),
      boxShadow: [
        BoxShadow(color: accent.withValues(alpha: .25), blurRadius: 24),
      ],
    ),
    child: Stack(
    ...
    child: AspectRatio(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (_, i) {
          ...
          final _ShopPreviewPiece? piece = item.category == 'PIECES'
              ? _previewPiece(i)
              : null;
          return Container(
            color: dark ? b : a,
