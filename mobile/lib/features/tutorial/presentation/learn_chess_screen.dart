...
class _CourseScreenState extends State<_CourseScreen> {
  ...
  @override
  Widget build(BuildContext context) {
    final bool compactHeader = MediaQuery.sizeOf(context).width < 700;
    return DesktopNavigationShell(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          toolbarHeight: compactHeader ? 112 : null,
          title: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
            ...
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(22),
                  border: Border.all(
                    color: course.accent.withValues(alpha: .65),
                  ),
                  image: DecorationImage(
                  ...
                  children: <Widget>[
                    ...
                    FilledButton(
                      onPressed: completedCount != course.chapters.length
                          ? null
                          : () async {
                              final List<AcademyLesson> lessons = course
                                  .chapters
                                  .map(AcademyCatalog.forChapter)
                                  .toList(growable: false);
