...
abstract final class MasterGameCatalog {
  static const List<MasterGameLesson> lessons = <MasterGameLesson>[
    ...
    MasterGameLesson(
      id: 'anand-gelfand-2012-game8',
      white: 'Viswanathan Anand',
      black: 'Boris Gelfand',
      event: 'FIDE World Championship · Game 8',
      year: 2012,
      result: '1–0',
      moveNumber: 1,
      sideToMove: 'White',
      question: 'Anand needed an immediate comeback. Which first move kept the widest choice of central plans?',
      choices: <String>['1. d4', '1. e4', '1. b3'],
      answer: '1. d4',
      idea: 'Anand chose a queen-pawn structure and delayed committing the centre. The flexible setup let him meet the Grünfeld dynamically; Gelfand later allowed his queen to become trapped.',
      continuation: <String>['1.d4', 'Nf6', '2.c4', 'g6', '3.f3'],
      style: MasterThinkingStyle.calculation,
      sourceLabel: 'Moscow 2012 · Shortest decisive classical WCC game',
      fen: 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1',
      masterFrom: 'd2',
      masterTo: 'd4',
    ),
    MasterGameLesson(
      id: 'kramnik-anand-2008-game3',
      white: 'Vladimir Kramnik',
      black: 'Viswanathan Anand',
      event: 'FIDE World Championship · Game 3',
      year: 2008,
      result: '0–1',
      moveNumber: 1,
      sideToMove: 'White',
      question: 'Which first move led into the Semi-Slav battle where Anand won with Black?',
      choices: <String>['1. d4', '1. c4', '1. e4'],
      answer: '1. d4',
      idea: 'The queen-pawn opening invited a strategic centre fight. Anand’s match preparation accepted a compact Semi-Slav structure, then used a timely central break when development was ready.',
      continuation: <String>['1.d4', 'd5', '2.c4', 'c6', '3.Nf3'],
      style: MasterThinkingStyle.calculation,
      sourceLabel: 'Bonn 2008 · Semi-Slav Meran · Match lead',
      fen: 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1',
      masterFrom: 'd2',
      masterTo: 'd4',
    ),
    MasterGameLesson(
      id: 'carlsen-anand-2008',
      white: 'Magnus Carlsen',
      black: 'Viswanathan Anand',
      ...
      moveNumber: 1,
      sideToMove: 'White',
      question: 'Which central move began the sharp Anti-Moscow Semi-Slav won by Anand?',
      choices: <String>['1. d4', '1. Nf3', '1. e4'],
      answer: '1. d4',
      idea: 'Carlsen claimed central space, while Anand built a resilient pawn chain before counterattacking. The game teaches that defence becomes active when the centre is challenged at the right moment.',
      continuation: <String>['1.d4', 'd5', '2.c4', 'c6', '3.Nf3'],
      style: MasterThinkingStyle.endurance,
      sourceLabel: 'Morelia 2008 · Anti-Moscow Gambit',
      fen: 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1',
      masterFrom: 'd2',
      masterTo: 'd4',
    ),
    MasterGameLesson(
      id: 'fischer-spassky-1972-game6',
      white: 'Bobby Fischer',
      black: 'Boris Spassky',
      ...
      moveNumber: 1,
      sideToMove: 'White',
      question: 'How did Fischer surprise Spassky before building one of his cleanest positional wins?',
      choices: <String>['1. c4', '1. e4', '1. f4'],
      answer: '1. c4',
      idea: 'Fischer departed from his usual king-pawn openings. The English move controlled d5, kept the pawn structure flexible, and forced Spassky to solve a different strategic problem at the board.',
      continuation: <String>['1.c4', 'e6', '2.Nf3', 'd5', '3.d4'],
      style: MasterThinkingStyle.endurance,
      sourceLabel: 'Reykjavik 1972 · World Championship Game 6',
      fen: 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1',
      masterFrom: 'c2',
      masterTo: 'c4',
    ),
    MasterGameLesson(
      id: 'tal-botvinnik-1960-game7',
      white: 'Mikhail Tal',
      ...
      moveNumber: 1,
      sideToMove: 'White',
      question: 'Which first move let Tal enter a Caro-Kann and build a direct attacking game?',
      choices: <String>['1. e4', '1. d4', '1. g3'],
      answer: '1. e4',
      idea: 'Tal occupied the centre and accepted a concrete Caro-Kann fight. His attack succeeded because development and open lines supported the sacrifice—not because sacrifice alone is magical.',
      continuation: <String>['1.e4', 'c6', '2.d4', 'd5', '3.Nc3'],
      style: MasterThinkingStyle.attack,
      sourceLabel: 'Moscow 1960 · Caro-Kann Classical',
      fen: 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1',
      masterFrom: 'e2',
      masterTo: 'e4',
    ),
