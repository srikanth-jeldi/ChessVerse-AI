...
- `chess_check.wav` - short tense check alert
- `chess_checkmate_dark.wav` - dramatic checkmate sound
- `chess_victory.wav` - win celebration
...
- `piece_queen.wav` - clean royal queen cue without the previous harsh roar
- `piece_king.wav` - current royal king cue
