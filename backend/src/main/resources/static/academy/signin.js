...
function academySignInView() {
  return `<div class="academy-signin"><section class="signin-story" aria-label="ChessVerseAI academy">
    ...
    </section><section class="signin-workspace"><div class="signin-access"><span>New to ChessVerseAI?</span><button type="button" data-signin="access">Request Access</button></div>
