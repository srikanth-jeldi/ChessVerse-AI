...
class OtpMailService implements OtpDelivery {
    ...
    private String buildHtml(
        ...
        for (int index = 0; index < safeCode.length(); index++) {
            digitBoxes.append("<td style=\"padding:0 3px\"><div style=\"width:42px;height:52px;line-height:52px;text-align:center;border:1px solid #e7b64f;border-radius:6px;background:#fff;color:#081725;font-family:Georgia,serif;font-size:27px;font-weight:700\">")
        ...
        return """
                ...
                <tr><td align="center" style="padding:30px 24px 32px;background-color:#061b2b;background-image:linear-gradient(135deg,#061523,#07354a 58%%,#062031)">
                ...
                <div style="margin-top:15px;color:#f4efe6;font-family:Georgia,serif;font-size:25px;font-weight:700;line-height:1.25">%s</div>
                <div style="margin-top:7px;color:#b9c7d2;font-size:13px;line-height:1.5">%s</div>
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="width:100%%;max-width:480px;margin-top:22px;background:#fff;border-radius:10px">
                <tr><td align="center" style="padding:22px 12px 10px;color:#536779;font-size:11px;font-weight:700;letter-spacing:1px">YOUR VERIFICATION CODE</td></tr>
                <tr><td align="center" style="padding:0 8px"><table role="presentation" cellspacing="0" cellpadding="0" border="0"><tr>%s</tr></table></td></tr>
                <tr><td align="center" style="padding:14px 12px 20px;color:#526272;font-size:12px"><span style="color:#24b9c7;font-size:17px">◷</span>&nbsp; Expires in 10 minutes</td></tr></table>
                </td></tr>
                <tr><td style="padding:26px 30px 10px;font-size:15px;line-height:1.65"><div style="font-size:18px;color:#132233">Hello %s,</div><div style="margin-top:12px;color:#465868">%s</div></td></tr>
                ...
                """.formatted(safeCode, escapeHtml(logoUrl), escapeHtml(heading), escapeHtml(heroCopy),
                digitBoxes, safeName, escapeHtml(bodyCopy), escapeHtml(warning));
    }
