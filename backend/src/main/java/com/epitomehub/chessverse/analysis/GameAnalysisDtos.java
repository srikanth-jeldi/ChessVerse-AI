...
final class GameAnalysisDtos {
    ...
    record CreateRequest(
            ...
            @Size(max = 400) List<@Pattern(regexp = "[a-h][1-8][a-h][1-8][qrbn]?", flags = Pattern.Flag.CASE_INSENSITIVE) String> moves,
            ...
            @Size(max = 400) List<@NotBlank @Size(max = 24) String> sanMoves) {
