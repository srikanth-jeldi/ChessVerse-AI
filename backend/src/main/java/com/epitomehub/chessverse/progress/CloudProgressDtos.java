...
final class CloudProgressDtos {
    ...
    record MergeRequest(
            ...
            @Min(0) int openingWeakness,
            @Min(0) int kingSafetyWeakness,
            @Min(0) int hangingPiecesWeakness,
            @Min(0) int missedCapturesWeakness,
            @Min(0) int timeManagementWeakness,
            @Min(0) int endgameWeakness,
